...
def expression_extract(func_name, params, table_schema_dict):
...
def read_blc_func_file(table_schema_dict):
    ...
    for raw_func, params in raw_functions_params:
        exp_sql = ""
        exp_sql  = expression_extract(raw_func, params, table_schema_dict)
        #print(exp_sql)
        if exp_sql != "":
...
if __name__ == "__main__":
    ...
    #expression_extract(table_schema_dict)
